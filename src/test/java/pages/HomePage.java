...
public class HomePage {
    ...
    private final By MINUS_CHILD = By.cssSelector("[aria-label=\"Детей: уменьшить количество\"]");
    private final By PLUS_CHILD = By.cssSelector("[aria-label=\"Детей: увеличить количество\"]");
    private final By MINUS_ROOM = By.cssSelector("[aria-label=\"Номера: уменьшить количество\"]");
